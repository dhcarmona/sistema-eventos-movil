...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { descripcion: @evento.descripcion, establecimiento_id: @evento.establecimiento_id, nombre: @evento.nombre }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { descripcion: @evento.descripcion, establecimiento_id: @evento.establecimiento_id, nombre: @evento.nombre }
    assert_redirected_to evento_path(assigns(:evento))
  end
