...
public class Manejo_Datos {
	...
	private void Establecimientos()
	{
		 new Thread(new Runnable() {
			    ...
			    public void run() {
			    	HttpGet httpRequest = new HttpGet( "http://semcr.no-ip.biz/establecimientos.json");				
	...
	private void Id_Eventos()
	{
		 new Thread(new Runnable() {
			    ...
			    public void run() {
			    	HttpGet httpRequest = new HttpGet( "http://semcr.no-ip.biz/eventos.json");				
					HttpClient httpclient = new DefaultHttpClient();					
					HttpResponse response;
					try {
						response = httpclient.execute(httpRequest);
	...
	private void Eventos(){
		new Thread(new Runnable() {
		    ...
		    public void run() {
		    	...
		    	String URL = "http://semcr.no-ip.biz/eventos/" + id_eventos.get(contador) +  ".json";
